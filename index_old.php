...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center header-transparent">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          <li><a class="nav-link scrollto" href="#hero">Get Started</a></li>
      ...
      <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active"
            style="background: url(assets/img/slide/slide-1.svg); background-repeat: no-repeat; background-size: cover; background-position: center">
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown"><span>Anything</span> To Anything</h2>
                <p class="animate__animated animate__fadeInUp">Trade between cryptocurrencies, equities and national
                  currencies in one single step.</p>
                <div>
                  <a href="signup.php" class="signup-btn animate__animated animate__fadeInUp scrollto">Signup Now</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="carousel-item"
            style="background: url(assets/img/slide/slide-2.svg); background-repeat: no-repeat; background-size: cover; background-position: center">
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown"><span>Buy</span> & <span>Sell</span></h2>
                <p class="animate__animated animate__fadeInUp">Buy and sell cryptocurrencies, equities and national
                  currencies in minutes.</p>
                <div>
                  <a href="signup.php" class="signup-btn animate__animated animate__fadeInUp scrollto">Signup Now</a>
                </div>
              </div>
          ...
          <!-- Slide 3 -->
          <div class="carousel-item"
            style="background: url(assets/img/slide/slide-3.svg); background-repeat: no-repeat; background-size: cover; background-position: center">
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown"><span>Anything</span> To Anything</h2>
                <p class="animate__animated animate__fadeInUp">Trade between cryptocurrencies, equities and national
  ...
  <main id="main">
    ...
    <section id="invest" class="about" style="background: #fff;">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-5 align-items-stretch video-box" style=\'background-image: url("assets/img/pf.png");\' style="margin-left: 40px;">
                </div>
    ...
    <section id="about" class="about">
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-lg-5 align-items-stretch video-box" style=\'background-image: url("assets/img/about.png");\' style="margin-right: 40px;">
    ...
    <section id="market" class="about" style="background: #fff;">
        <div class="section-title">
          <h2>Trending <span>Markets</span></h2>
        </div>
        <div class="container-fluid">
  ...
  <script src="assets/js/main.js"></script>
    <script>
        https: var list = {
            url:
                "https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&ids=bitcoin,ethereum,dogecoin,matic-network,ripple,terra-luna,litecoin,monero&order=market_cap_desc&per_page=100&page=1&sparkline=false&price_change_percentage=24h",
            method: "GET",
            timeout: 0,
        };
